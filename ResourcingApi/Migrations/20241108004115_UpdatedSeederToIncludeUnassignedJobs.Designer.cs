...
namespace ResourcingApi.Migrations
{
    ...
    [Migration("20241108004115_UpdatedSeederToIncludeUnassignedJobs")]
    partial class UpdatedSeederToIncludeUnassignedJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResourcingApi.Models.JobTemp", b =>
                {
            ...
            modelBuilder.Entity("ResourcingApi.Models.JobTemp", b =>
                {
                    b.HasOne("ResourcingApi.ResourcingJob.Job", "Job")
                        .WithMany("JobTemps")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResourcingApi.ResourcingTemp.Temp", "Temp")
                        .WithMany("JobTemps")
